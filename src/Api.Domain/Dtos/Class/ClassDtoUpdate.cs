...
namespace Api.Domain.Dtos.Class
{
    public class ClassDtoUpdate
    {
        ...
        [StringLength(100, MinimumLength=5, ErrorMessage = "Dias da semana deve ter no máximo {1} caracteres.")]
        ...
        [StringLength(36, MinimumLength=5, ErrorMessage = "Identificador da escola deve ter no máximo {1} caracteres.")]
